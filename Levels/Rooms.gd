...
const SPAWN_ROOMS: Array = [ preload("res://Levels/Rooms/SpawnRooms/SpawnRoom1.tscn"),
preload("res://Levels/Rooms/SpawnRooms/SpawnRoom2.tscn")
]

const INTERMEDIATE_ROOMS: Array = [ preload("res://Levels/Rooms/Room0.tscn"), preload("res://Levels/Rooms/Room1.tscn"), preload("res://Levels/Rooms/Room3.tscn")
]

const END_ROOMS: Array = [ preload("res://Levels/Rooms/EndRooms/EndRooms1.tscn"),
preload("res://Levels/Rooms/EndRooms/EndRooms2.tscn")
]


const TILE_SIZE: int = 16
const FLOOR_TILE_INDEX: int = 4
const RIGHT_WALL_TILE_INDEX: int = 10
const LEFT_WALL_TILE_INDEX: int = 11
...
func _spawn_rooms() -> void:
	...
	for i in num_levels:
		...
		if i == 0:
			...
			var corridor_height: int = randi() % 20 + 2
